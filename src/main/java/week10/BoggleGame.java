package week10; /******************************************************************************
 *  Compilation:  javac week10.BoggleGame.java
 *  Execution:    java week10.BoggleGame [m n]
 *  Dependencies: week10.BoggleSolver.java week10.BoggleBoard.java
 ...
 *
 *  % javac week10.BoggleGame.java
 *  
 *  % java week10.BoggleGame
 *
 *  % java -Xmx300m week10.BoggleGame 3 7
 *  
            ...
            public void run() {
                ...
                if (args.length == 0) {
                    ...
                    try {
                        ...
                        System.err.println("Usage: java week10.BoggleGame " +
                                           "\nor:    java week10.BoggleGame [rows]" +
                                           "\nor:    java week10.BoggleGame [rows] [cols]");
                        System.exit(1);
                    }
                }
